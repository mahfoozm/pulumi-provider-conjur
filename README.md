...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `conjur` with the `NAME` of your provider.
...
- binary: pulumi-resource-conjur
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-conjur/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-conjur/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-conjur_darwin_amd64_v1
│   └── pulumi-resource-conjur
├── pulumi-conjur_darwin_arm64
│   └── pulumi-resource-conjur
├── pulumi-conjur_linux_amd64_v1
│   └── pulumi-resource-conjur
├── pulumi-conjur_linux_arm64
│   └── pulumi-resource-conjur
├── pulumi-conjur_windows_amd64_v1
│   └── pulumi-resource-conjur.exe
└── pulumi-conjur_windows_arm64
    └── pulumi-resource-conjur.exe
```
