module github.com/mahfoozm/pulumi-provider-conjur/provider
...
require (
	github.com/cyberark/terraform-provider-conjur v0.6.5
...
require (
	...
	github.com/cyberark/conjur-api-go v0.10.1 // indirect
